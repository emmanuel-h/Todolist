...
**A swipe is answered in the direction it was taken, or not at all.** The furthest the row was ever pulled during one gesture decides which action it is; the release can only confirm or call it off. A finger leaving a swipe very often flicks back a hair, and reading the row's position at that instant let the flick land it on the other side and do the *opposite* of what the reader had just watched themselves uncover. Dragging the row back past where it started calls the swipe off; a twitch does not.
