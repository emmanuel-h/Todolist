...
- [Paper Design System](paper-design-system.md) — the ink-on-paper look ported to Compose as `ui/paper/`: palette and dimension objects, named spring specs, and previewable primitives (`PaperSurface`, `RuledRow`, `GhostRow`, `InkIcon`, `CountBadge`, `StickyNotePad`); grain and hole punches now drawn instead of tiled from PNGs; no screen consumes it yet
