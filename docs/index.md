...
- [Dynamic Color + Tonal Surfaces](dynamic-color-tonal-surfaces.md) — Android 12+ wallpaper palette via DynamicColors; refined-violet fallback (seed #7C3AED) on older APIs; tonal surface hierarchy replaces drop shadows
